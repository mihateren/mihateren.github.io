...
В нашем случае `int` и `double` являются типами данных для переменных `a` и `b` соответственно.
...
5. [Консольный ввод-вывод](https://metanit.com/java/tutorial/2.9.php) (без этого домашку не сделать)
